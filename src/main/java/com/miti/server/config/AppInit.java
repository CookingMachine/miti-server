...
public class AppInit implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) {
    ...
    addUser(users, "moder", "Govnoy",
      "$2y$12$zbcKnFG.OX.7r2k3nqEyj.9psdQhVzIy5eBvtVQegbPGVHupC0NHS", "moder@gmail.com", Role.MODERATION);
    addUser(users, "user", "Lyoha",
      "$2y$12$hrib5eAGooCIRrfViL4tju04yqpKdynd67YFqhCaTTPyOdjwEz1ia", "user@gmail.com", Role.USER);
    addUser(users, "poopGrabber", "НИколай22",
      "$2y$12$hrib5eAGooCIRrfViL4tju04yqpKdynd67YFqhCaTTPyOdjwEz1ia", "poop@yandex.ru", Role.USER);
    addUser(users, "pussyKiller2008", "Антошка",
      "$2y$12$hrib5eAGooCIRrfViL4tju04yqpKdynd67YFqhCaTTPyOdjwEz1ia", "anton2008bashkin@yahoo.com", Role.MODERATION);
    addUser(users, "youToo", "xxx",
      "$2y$12$hrib5eAGooCIRrfViL4tju04yqpKdynd67YFqhCaTTPyOdjwEz1ia", "xxx@yandex.ru", Role.USER);
    addUser(users, "robotDolby", "Cipa",
      "$2y$12$hrib5eAGooCIRrfViL4tju04yqpKdynd67YFqhCaTTPyOdjwEz1ia", "ikop@mial.ru", Role.USER);
    ...
    addContextIngredient(contextIngredients, 1L, Measure.Ml, ingredientService.getIngredientById("cucumber"),
      recipeService.getRecipeById(1L));
    addContextIngredient(contextIngredients, 2L, Measure.Sl, ingredientService.getIngredientById("paprika_red"),
      recipeService.getRecipeById(3L));
    addContextIngredient(contextIngredients, 10L, Measure.Sht, ingredientService.getIngredientById("cucumber_marinade"),
      recipeService.getRecipeById(1L));
    addContextIngredient(contextIngredients, 1L, Measure.Kg, ingredientService.getIngredientById("cucumber"),
      recipeService.getRecipeById(2L));
    addContextIngredient(contextIngredients, 1L, Measure.Chl, ingredientService.getIngredientById("paprika_red"),
      recipeService.getRecipeById(1L));
    addContextIngredient(contextIngredients, 1L, Measure.Gr, ingredientService.getIngredientById("paprika_yellow"),
      recipeService.getRecipeById(1L));
    addContextIngredient(contextIngredients, 1L, Measure.Lit, ingredientService.getIngredientById("tomato"),
      recipeService.getRecipeById(3L));
    addContextIngredient(contextIngredients, 1L, Measure.St, ingredientService.getIngredientById("cucumber_salt"),
      recipeService.getRecipeById(1L));
    addContextIngredient(contextIngredients,2L, Measure.Ml, ingredientService.getIngredientById("paprika_red"),
      recipeService.getRecipeById(2L));
    addContextIngredient(contextIngredients, 1L, Measure.Ml, ingredientService.getIngredientById("cucumber"),
      recipeService.getRecipeById(11L));
    addContextIngredient(contextIngredients, 2L, Measure.Sl, ingredientService.getIngredientById("paprika_red"),
      recipeService.getRecipeById(11L));
    addContextIngredient(contextIngredients, 10L, Measure.Sht, ingredientService.getIngredientById("cucumber_marinade"),
      recipeService.getRecipeById(11L));
    ...
    addContextIngredient(contextIngredients, 1L, Measure.Gr, ingredientService.getIngredientById("paprika_yellow"),
      recipeService.getRecipeById(10L));
    addContextIngredient(contextIngredients, 1L, Measure.Lit, ingredientService.getIngredientById("tomato"),
      recipeService.getRecipeById(9L));
    addContextIngredient(contextIngredients, 1L, Measure.St, ingredientService.getIngredientById("cucumber_salt"),
      recipeService.getRecipeById(9L));
    addContextIngredient(contextIngredients,2L, Measure.Ml, ingredientService.getIngredientById("paprika_red"),
      recipeService.getRecipeById(9L));
    addContextIngredient(contextIngredients, 1L, Measure.Ml, ingredientService.getIngredientById("cucumber"),
      recipeService.getRecipeById(9L));
    addContextIngredient(contextIngredients, 2L, Measure.Sl, ingredientService.getIngredientById("paprika_red"),
      recipeService.getRecipeById(8L));
    addContextIngredient(contextIngredients, 10L, Measure.Sht, ingredientService.getIngredientById("cucumber_marinade"),
      recipeService.getRecipeById(7L));
    addContextIngredient(contextIngredients, 1L, Measure.Kg, ingredientService.getIngredientById("cucumber"),
      recipeService.getRecipeById(8L));
    addContextIngredient(contextIngredients, 1L, Measure.Chl, ingredientService.getIngredientById("paprika_red"),
      recipeService.getRecipeById(7L));
    addContextIngredient(contextIngredients, 1L, Measure.Gr, ingredientService.getIngredientById("paprika_yellow"),
      recipeService.getRecipeById(7L));
    addContextIngredient(contextIngredients, 1L, Measure.Lit, ingredientService.getIngredientById("tomato"),
      recipeService.getRecipeById(6L));
    addContextIngredient(contextIngredients, 1L, Measure.St, ingredientService.getIngredientById("cucumber_salt"),
      recipeService.getRecipeById(6L));
    addContextIngredient(contextIngredients,2L, Measure.Ml, ingredientService.getIngredientById("paprika_green"),
      recipeService.getRecipeById(6L));
    addContextIngredient(contextIngredients, 1L, Measure.Ml, ingredientService.getIngredientById("cucumber"),
