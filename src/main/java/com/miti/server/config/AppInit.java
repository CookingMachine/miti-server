...
public class AppInit implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) {
    ...
    addUser(users, "user", "Lyoha",
        "$2y$12$hrib5eAGooCIRrfViL4tju04yqpKdynd67YFqhCaTTPyOdjwEz1ia", "user@gmail.com",
        Role.USER);
    addUser(users, "poopGrabber", "НИколай22",
        "$2y$12$hrib5eAGooCIRrfViL4tju04yqpKdynd67YFqhCaTTPyOdjwEz1ia", "poop@yandex.ru",
        Role.USER);
    addUser(users, "pussyKiller2008", "Антошка",
        "$2y$12$hrib5eAGooCIRrfViL4tju04yqpKdynd67YFqhCaTTPyOdjwEz1ia",
        "anton2008bashkin@yahoo.com", Role.MODERATION);
    ...
    addContextIngredient(contextIngredients, 1L, Measure.Ml,
        ingredientService.getIngredientById("cucumber"),
        recipeService.getRecipeById(1L));
    addContextIngredient(contextIngredients, 2L, Measure.Sl,
        ingredientService.getIngredientById("paprika_red"),
        recipeService.getRecipeById(3L));
    addContextIngredient(contextIngredients, 10L, Measure.Sht,
        ingredientService.getIngredientById("cucumber_marinade"),
        recipeService.getRecipeById(1L));
    addContextIngredient(contextIngredients, 1L, Measure.Kg,
        ingredientService.getIngredientById("cucumber"),
        recipeService.getRecipeById(2L));
    addContextIngredient(contextIngredients, 1L, Measure.Chl,
        ingredientService.getIngredientById("paprika_red"),
        recipeService.getRecipeById(1L));
    addContextIngredient(contextIngredients, 1L, Measure.Gr,
        ingredientService.getIngredientById("paprika_yellow"),
        recipeService.getRecipeById(1L));
    addContextIngredient(contextIngredients, 1L, Measure.Lit,
        ingredientService.getIngredientById("tomato"),
        recipeService.getRecipeById(3L));
    addContextIngredient(contextIngredients, 1L, Measure.St,
        ingredientService.getIngredientById("cucumber_salt"),
        recipeService.getRecipeById(1L));
    addContextIngredient(contextIngredients, 2L, Measure.Ml,
        ingredientService.getIngredientById("paprika_red"),
        recipeService.getRecipeById(2L));
    addContextIngredient(contextIngredients, 1L, Measure.Ml,
        ingredientService.getIngredientById("cucumber"),
    ...
    addContextIngredient(contextIngredients, 1L, Measure.St,
        ...
        recipeService.getRecipeById(6L));
    addContextIngredient(contextIngredients, 2L, Measure.Ml,
        ingredientService.getIngredientById("paprika_green"),
        recipeService.getRecipeById(6L));
    addContextIngredient(contextIngredients, 1L, Measure.Ml,
        ingredientService.getIngredientById("cucumber"),
